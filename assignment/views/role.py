...
class RolesView(BaseView):
    ...
    def get(self, request):
        try:
            ...
            if uuid_opts_dict:
                obj = self.role_model.get_obj(**uuid_opts_dict)
    ...
    def post(self, request):
        try:
            # 参数提取
            necessary_opts = ['name', 'domain', 'description']
            ...
            # 创建对象
            obj = self.role_model.create_obj(**obj_field)
    ...
    def put(self, request):
        try:
            ...
            updated_obj = self.role_model.update_obj(obj, **extra_opts_dict)
    ...
    def delete(self, request):
        try:
            ...
            # 对象获取
            deleted_obj = self.role_model.delete_obj(**necessary_opts_dict)
